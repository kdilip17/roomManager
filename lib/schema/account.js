...
account.loginReq = joi.object({
    username: joi.string().required().description("This is Unique Email or Mobile number with country code for Ex: 919843076661 like that"),
    password: joi.string().required(),
    mode    : joi.string().required().valid(['CMS', 'WEB'])
}).meta({
    className: 'LoginReq'
});
